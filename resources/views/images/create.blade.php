...
<div class="form-container">
    <div class="form-header">
        ...
        <p class="form-subtitle">Share your visual creations with the community</p>
    </div>
    ...
    <form method="POST" action="{{ route('images.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-card">
            ...
            <div class="form-section">
                ...
                <div class="form-help">Accepted formats: JPEG, PNG, JPG, GIF, WebP. Max size: 5MB</div>
                @error('image_path')
        ...
        <div class="form-actions">
            ...
            <a href="{{ route('images.index') }}" class="btn-cancel">Cancel</a>
        </div>
    </form>
</div>
